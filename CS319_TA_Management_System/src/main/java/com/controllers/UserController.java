...
public class UserController {
    ...
    private final DeansOfficeService deanService;
    ...
    DepartmentStaffService departmentStaffService, DepartmentChairService departmentChairService, DeansOfficeService deanService) {
    ...
    public User createUser(@RequestBody User user) {
        ...
        DeansOffice deansOffice = (DeansOffice) user;
        return deanService.createDeansOffice(
            deansOffice.getName(),
